import {useLocalStorageState} from '../util/utils';
import {Keypair, AccountInfo, Connection, PublicKey} from '@safecoin/web3.js';
import React, {useContext, useEffect, useMemo} from 'react';
import {setCache, useAsyncData} from '../util/fetch-loop';
import { tuple } from 'immutable-tuple';
import {ConnectionContextValues, EndpointInfo} from "../util/conn-types";
...
export const ENDPOINTS: EndpointInfo[] = [
  ...
  { name: 'localnet', endpoint: 'http://127.0.0.1:8328', custom: false },
];
